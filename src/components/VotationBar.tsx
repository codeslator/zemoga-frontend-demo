...
const VotationBar: FC<VotationBar> = ({ votes }) => {
  ...
  return (
    <div className="votation__bar absolute bottom-0 flex justify-between w-full h-20 md:h-12">
      <div className={`votation__positive h-full bg-dark-teal flex items-center justify-start px-6 md:px-4`} style={{ width: `${getTotalPercentPositiveVotes()}%` }}>
      ...
      <div className={`votation__negative h-full bg-dark-yellow flex items-center justify-end px-6 md:px-4`} style={{ width: `${getTotalPercentNegativeVotes()}%` }}>
