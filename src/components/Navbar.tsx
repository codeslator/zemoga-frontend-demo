...
const Navbar: FC<NavbarProps> = ({ title }) => {
  return (
    <nav id="nav" className="bg-gradient-to-b from-neutral-900 to-transparent border-gray-200 lg:px-4 dark:bg-gray-800 lg:min-h-[22vh] flex items-center fixed z-[2] w-full">
      <div className="lg:container w-full lg:w-[80%] lg:px-14 lg:mx-auto flex flex-wrap justify-between items-center">
        <a href="https://flowbite.com" className="flex items-center py-2">
          <h1 className="self-center text-4xl whitespace-nowrap text-white pl-2">{title}</h1>
        </a>
        <div className="flex items-center lg:order-2 pr-2">
          <button data-collapse-toggle="mobile-menu-2" type="button" className="inline-flex items-center p-2 ml-1 text-sm text-gray-500 lg:hidden hover:bg-transparent focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700" aria-controls="mobile-menu-2" aria-expanded="false">
            <svg className="w-10 h-10" fill="white" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd"></path></svg>
            <svg className="hidden w-10 h-10" fill="white" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
          </button>
        </div>
        <div className="hidden justify-between items-center w-full h-full lg:flex lg:w-auto lg:order-2 p-20 lg:p-0" id="mobile-menu-2">
