  ...
  return (
    <section className="w-full mt-2">
      ...
      <div className="votation__list my-4">
        <article className="votation__item mb-2 h-[200px] relative">
          <div className="votation__container w-full h-full flex justify-between">
            ...
            <div className="votation__info w-full md:w-[80%] h-full px-4 py-3 flex justify-between absolute right-0 votation-card-gradient text-white">
              <div className="votation__data w-[65%]">
                <h6 className="votation__name text-lg lg:text-3xl">Elon Musk</h6>
                <p className="votation__description text-base lg:text-md">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis eaque atque reiciendis enim, consectetur repellat possimus inventore accusantium debitis magni?</p>
              </div>
              <div className="votation__actions w-[35%]">
                <div className="votation__date text-[16px] text-right">1 month ago in Entertainment</div>
            ...
            <div className="votation__bar absolute bottom-0 flex justify-between w-full h-12">
              <div className="votation__possitive w-[50%] h-full bg-dark-teal flex items-center justify-start">2</div>
              <div className="votation__negative  w-[50%] h-full bg-dark-yellow flex items-center justify-end">3</div>
            </div>
          </div>
        </article>
      </div>
